...
function drawHighlighter(a){drawEnabled&&"highlighter"==activeIcon.id&&(canvas.context.beginPath(),console.log(canvas,a.clientX-canvas.posX,a.clientY-canvas.posY),canvas.context.arc(a.clientX-canvas.posX,a.clientY,5,0,2*Math.PI,!1),canvas.context.fillStyle="#ff0000",canvas.context.fill())}
