...
var tabInfo=null,background=chrome.extension.getBackgroundPage(),Main=function(){this.activeTool={id:"paint-brush"};this.toolInfo={paintBrush:{color:"#FFFF00",defaultColor:"#FFFF00",size:5,opacity:1},eraser:{size:5}}};Main.prototype.init=function(){this.attachHandlers()};Main.prototype.reload=function(a){console.log(a);this.toolInfo=this.activeTool=null;for(key in a)this[key]=a[key];console.log(this);this.attachHandlers();this.reloadValues()};
Main.prototype.attachHandlers=function(){Array.from(document.querySelectorAll(".tab-title.tool")).forEach(function(a){a.addEventListener("click",this.toolClickHandler.bind(this,a))},this);Array.from(document.querySelectorAll(".tab-content.active .color")).forEach(function(a){a.addEventListener("click",this.colorClickHandler.bind(this,a))},this);Array.from(document.querySelectorAll(".tab-content.active input.size-range, .tab-content.active input.opacity-range")).forEach(function(a){a.addEventListener("change",
this.rangeHandler.bind(this,a))},this)};
Main.prototype.reloadValues=function(){var a="[data-tool-id\x3d'"+this.activeTool.id+"']",c=document.querySelector(".tab-title"+a);this.toolClickHandler(c);if("paint-brush"===this.activeTool.id){c=document.querySelector(".tab-content"+a+" .color[data-color-code\x3d'"+this.toolInfo.paintBrush.color+"']");var b=document.querySelector(".tab-content"+a+" .size-range");a=document.querySelector(".tab-content"+a+" .opacity-range");b.value=this.toolInfo.paintBrush.size;a.value=100-100*this.toolInfo.paintBrush.opacity;
this.colorClickHandler(c);this.rangeHandler(b);this.rangeHandler(a)}};Main.prototype.toolClickHandler=function(a){if(!a.classList.contains("active")){var c=a.dataset.toolId;this.disableAllTools();a.classList.add("active");document.querySelector(".tab-content[data-tool-id\x3d'"+c+"']").classList.add("active");this.activeTool.id=c}};
...
window.onunload=function(a){background.popupObjects[tabInfo.id]=object};window.onload=function(){chrome.tabs.query({active:!0},function(a){tabInfo=a=a[0];chrome.runtime.sendMessage({message:"init-object",tabId:a.id},function(a){console.log(a);"do-it-yourself"!==a.data?(console.log(a.data),object.reload(a.data)):object.init()})})};